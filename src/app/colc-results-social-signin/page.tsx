        ...
        <div className='max-w-container mx-auto'>
            <div className='results_container flex flex-col lg:flex-row md:gap-[40px] lg:gap-[20px] md:px-[20px] lg:px-[0] pb-[40px] md:py-[40px]'>
                <section className='results_card flex flex-col  w-full md:rounded-t-[8px] overflow-hidden'>
                    ...
                    <aside className='promotion_pod w-full lg:min-w-[392px] lg:w-[392px] min-h-[226px] lg:min-h-[403px] lg:hidden md:pt-[40px]'>
                        <Image className='block md:hidden w-full md:rounded-[8px]' src="/assets/images/colc/promotion_app_img_mobile.jpg" alt="" width="392" height="403" />
                        <Image className='hidden md:block lg:hidden w-full' src="/assets/images/colc/promotion_app_img_1.jpg" alt="" width="728" height="226" />
                    </aside>
                ...
                <Image className='block w-full md:rounded-[8px]' src="/assets/images/colc/promotion_app_img_mobile.jpg" alt="" width="392" height="403" />
                </aside>
            </div>
        </div>
        <Advicecomponents />

  ...
  return (
    ...
    <div className="review-card-header flex gap-[8px] border-b border-neutrale-200 pb-[16px]">
        ...
        <div className="review-box__details flex flex-col justify-center w-[calc(100%_-_48px)]">
          <div className="review-box__name font-semibold small text-grey-300 line-clamp-1">Archie Kinkead</div>
          <div className="review-box__uniname small text-grey-300 line-clamp-1">University of Kent</div>

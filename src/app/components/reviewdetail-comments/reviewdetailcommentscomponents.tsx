                ...
                <div className="flex flex-col gap-[20px]">
                  ...
                  <div className="flex flex-col gap-[8px]">
                    ...
                    <p className="small text-grey300 ">
                      I started on the wrong course for me but was supported
                      greatly in the transition to something better suited! All
                      the stuff are so lovely and I feel truly cared for by my
                      teachers. I have learned so much already and have been
                      inspired from being surrounded by so much passion and
                      talent. There are so many opportunities to play and create
                      in a range of ensembles, and I am happy here.
                    </p>
                    <ul className="flex flex-wrap gap-x-[16px] gap-y-[2px] *:text-small *:text-grey300 *:font-semibold w-full md:w-[375px] bg-grey-100 p-[16px] rounded-[8px]">

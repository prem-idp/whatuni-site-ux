          ...
          <div className='subjectarea-pod shadow-[0px 1px 3px 0px rgba(16, 24, 40, 0.1)] rounded-[4px]'>
            ...
            <div className='subjectarea-body'>
              <ul className='flex flex-col gap-[3px] p-[16px]'>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Finance</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Entrepreneurship</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Accounting</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Project Management</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Marketing</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Management</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Management Accounting</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Operations Management</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Supply Chain Management</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Business Administration</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Human Resource Management</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Financial Management</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>Sales Management</a></li>
                <li><a href='#' className='font-regular small text-secondary-500 hover:underline'>International Business Studies</a></li>
              </ul>
            </div>
            <div className='subjectarea-footer'>
              <a href='#'>Architectural History 

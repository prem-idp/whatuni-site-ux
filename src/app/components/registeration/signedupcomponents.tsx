...
import SignedupSkeleton from "../skeleton/signedupskeleton";
        ...
        <div className="signedup w-full flex flex-col self-start px-[16px] md:px-[24px] pt-[40px] pb-[16px] md:pb-[24px] gap-[16px]">
          ...
          <div className="thanks_card flex flex-col gap-[4px]">
            ...
            <p className="small font-normal text-grey300">
              If you’re not a student researching for yourself, let us know so
              we can plan some great content tailored for you.
            </p>
          </div>

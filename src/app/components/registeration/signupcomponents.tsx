        ...
        <div className='registeration-container flex flex-col md:flex-row h-[100vh] overflow-auto md:h-[100%]'>
            ...
            <div className='regist-col w-full flex items-center relative'>
                ...
                <div className='signup w-full flex flex-col self-start px-[16px] md:px-[24px] md:pr-0 py-[16px] md:py-[40px] gap-[16px]'>                       
                    ...
                    <div className='small font-semibold text-grey300 text-center'>Already have an account? <Link href="/registeration/signin" className='text-primary-400 hover:text-primary-500 hover:underline'>Sign in</Link> </div>
                    <form className='signup_form w-full h-full'>
                        <div className='form_container flex flex-col gap-[16px] pb-[70px] md:pr-[24px] md:pb-[14px] md:custom-scrollbar-2 md:max-h-[345px] md:overflow-y-auto'>
                            <div className='form_group flex flex-col md:flex-row gap-[8px]'>
                                <div className="col flex flex-col basis-full md:basis-6/12 gap-[4px]">
                                    <label htmlFor="firstName" className="form-label small font-semibold text-grey300">First name*</label>
                                    <input type="text" className="form-control w-full small font-normal text-grey300 px-[12px] py-[10px] border border-grey-500 rounded-[4px] outline-none shadow-custom-2" id="firstName" defaultValue="Neil" />
                                    <div className='success_msg'><p className='x-small font-normal text-positive-default'>Nice to meet you</p></div>
                                    <div className='err_msg'><p className='x-small font-normal text-negative-default'>We still don’t know your name, Remind us?</p></div>
                                </div>
                                <div className="col  flex flex-col basis-6/12 gap-[4px]">
                                    <label htmlFor="lastName" className="form-label small font-semibold text-grey300">Last name*</label>
                                    <input type="text" className="form-control w-full small font-normal text-grey300 px-[12px] py-[10px] border border-grey-500 rounded-[4px] outline-none shadow-custom-2" id="lastName" defaultValue="Burgess" />
                                    <div className='err_msg'><p className='x-small font-normal text-negative-default'>We still don’t know your name, Remind us?</p></div>
                                </div>
                            </div>
                            <div className='form_field'>
                                <div className="col flex flex-col basis-full gap-[4px] error">
                                    ...
                                    <input type="email" className="form-control w-full small font-normal text-grey300 px-[12px] py-[10px] border border-grey-500 rounded-[4px] outline-none shadow-custom-2" id="emailAddress" defaultValue="neil.burgess@idp.com" />
                            ...
                            <div className='form_group flex flex-row gap-[8px]'>
                                <div className="col flex flex-col basis-6/12 gap-[4px] error">
                                    <label htmlFor="postcode" className="form-label small font-semibold text-grey300">Postcode</label>
                                    <input type="text" className="form-control w-full small font-normal text-grey300 px-[12px] py-[10px] border border-grey-500 rounded-[4px] outline-none shadow-custom-2" id="postcode"  value="EH16DJ"/>
                                </div>
                            ...
                            <div className='form_radio flex flex-col gap-[4px]'>
                                <label className="check-label small font-semibold text-grey300">When do you plan to start uni?</label>
                                <div className='form-radio-group flex flex-row gap-[6px] md:gap-[8px]'>
                                    <div className="col flex relative">
                                        <input type="radio" name="yoe" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="2025" />
                                        <label htmlFor="2025" className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]">2025</label>                            
                                    </div>
                                    <div className="col flex relative">
                                        <input type="radio" name="yoe" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="2026" />
                                        <label htmlFor="2026" className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]">2026</label>                            
                                    </div>
                                    <div className="col flex relative">
                                        <input type="radio" name="yoe" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="2027" />
                                        <label htmlFor="2027" className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]">2027</label>                            
                                    </div>
                                    <div className="col flex relative">
                                        <input type="radio" name="yoe" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="2028" />
                                        <label htmlFor="2028" className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]">2028</label>                            
                                    </div>
                                </div>           
                            </div>
                            <div className='form_check flex flex-col gap-[4px]'>
                                <label className="check-label small font-semibold text-grey300">Stay up to date via email <span className='x-small font-normal text-grey-700'>(optional)</span></label>
                                <div className='form-check-group flex flex-col gap-[8px]'>
                                    <div className="col flex items-start gap-[12px] relative">
                                        ...
                                        <span className='x-small font-semibold text-grey-600'>Newsletters and uni updates <span className='x-small font-normal text-grey-700'>(tick to opt in)</span></span>
                                        <p className='x-small font-normal text-grey-600'>Emails from us and our carefully selected third party providers providing you with the latest uni news, tips and guides.</p>
                                        </label>                            
                                    </div>
                                    <div className="col flex items-start gap-[12px] relative">
                                        <div className='checkbox_card'>
                                            <input type="checkbox" className="form-checkbox hidden" id="Surveys" />
                                            <label htmlFor='Surveys' className='flex justify-center items-center w-[16px] h-[16px] rounded-[3px] border border-grey-400 my-[6px]'>
                                            <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M9.2534 0.723569C9.40607 0.863517 9.41638 1.10073 9.27643 1.2534L3.77643 7.2534C3.70732 7.3288 3.6104 7.37269 3.50815 7.37491C3.40589 7.37714 3.30716 7.33749 3.23483 7.26517L0.734835 4.76517C0.588388 4.61872 0.588388 4.38128 0.734835 4.23484C0.881282 4.08839 1.11872 4.08839 1.26517 4.23484L3.48822 6.45789L8.72357 0.746605C8.86351 0.593936 9.10073 0.583622 9.2534 0.723569Z" fill="white" stroke="white" strokeWidth="0.666667" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                            </label>
                                        </div>
                                        <label htmlFor="Surveys" className="check-label small font-semibold w-[calc(100%_-_28px)]">
                                        <span className='x-small font-semibold text-grey-600'>Surveys <span className='x-small font-normal text-grey-700'>(tick to opt in)</span></span>
                                        <p className='x-small font-normal text-grey-600'>Have your say on important education issues and the services you recieve from us and our partners</p>
                                        </label>                            
                                    </div>
                                    <div className="col privacy_notice flex items-start gap-[12px] relative pt-[16px] mt-[7px] border-t border-t-grey-200">
                                        <div className='checkbox_card'>
                                            <input type="checkbox" className="form-checkbox hidden" id="privacy" />
                                            <label htmlFor='privacy' className='flex justify-center items-center w-[16px] h-[16px] rounded-[3px] border border-grey-400 my-[3px]'>
                                                <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M9.2534 0.723569C9.40607 0.863517 9.41638 1.10073 9.27643 1.2534L3.77643 7.2534C3.70732 7.3288 3.6104 7.37269 3.50815 7.37491C3.40589 7.37714 3.30716 7.33749 3.23483 7.26517L0.734835 4.76517C0.588388 4.61872 0.588388 4.38128 0.734835 4.23484C0.881282 4.08839 1.11872 4.08839 1.26517 4.23484L3.48822 6.45789L8.72357 0.746605C8.86351 0.593936 9.10073 0.583622 9.2534 0.723569Z" fill="white" stroke="white" strokeWidth="0.666667" strokeLinecap="round" strokeLinejoin="round"/>
                                                </svg>
                                            </label>
                                        </div>
                                        <label htmlFor="privacy" className="check-label small font-semibold w-[calc(100%_-_28px)]">
                                        <p className='x-small font-normal text-grey-600'>I confirm I’m over 13 and agree to the <Link href="" className='text-primary-400 hover:text-primary-500 hover:underline'>terms and conditions</Link> and <Link href="" className='text-primary-400 hover:text-primary-500 hover:underline'>privacy notice</Link>, and to become a member of the Whatuni community*</p>
                                        </label>                            
                                    </div>
                                    <div className='err_msg'><p className='x-small font-normal text-negative-default'>Please agree to our terms and conditions</p></div>                                        
                                </div>           
                            </div>
                        </div>

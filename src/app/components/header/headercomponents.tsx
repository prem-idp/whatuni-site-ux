          ...
          <div className="order-3 basis-[100%] md:grow lg:grow-0 lg:basis-0">
            <ul className="flex items-center justify-end gap-[10px] rightmenu">
              ...
              <li
                ...
                className="relative rounded-[34px] flex items-center justify-center w-[48px] h-[48px] cursor-pointer hover:border-primary-500 hover:bg-primary-500"
              >
                <svg
                  width="24"
                  height="24"
                ...
                <div className="absolute inline-flex items-center justify-center w-[16px] h-[16px] rounded-[8px] top-[22px] right-[6px] bg-success-400 text-black font-inter font-semibold xs-small px-[5px] py-[2px]">
                  2
                </div>
                {/* shortlist section */}
                {isShortlistClicked && (

  ...
  return (
    ...
    <AnimatePresence>
        ...
        <motion.div 
            ...
            className='modal-box shadow-custom-6 w-full md:w-[720px] lg:w-[987px] p-[0] md:p-[20px] lg:p-[24px] bg-white md:rounded-[8px] fixed top-0 md:top-[60px] left-0 right-0 mx-auto h-[100vh] md:h-[calc(100vh-120px)]'>

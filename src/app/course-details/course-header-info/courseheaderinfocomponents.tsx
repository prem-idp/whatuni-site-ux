            ...
            <div className="uniresults-inner flex flex-col md:flex-row md:gap-[24px]">
              <div className="uniresults-left">
                <div className="univ__logo bg-white p-[4px] w-[120px] rounded-[8px] shadow-custom-4 overflow-hidden hidden md:block">
                  <Image
                    className="w-full"
                    src="/assets/images/myhc_252670.jpg"
                    alt="uni logo"
                    width={112}
                    height={112}
                  />
              ...
              <div className="uniresults-right flex flex-col flex-1 gap-[16px]">
                ...
                >
                  ...
                  <div className="flex flex-col gap-[8px]">
                    <a
                      href="#"
                      className="block w-fit para-lg font-semibold text-primary-400 hover:text-primary-500 hover:underline"
                    >
                    ...
                    <div className="flex">
                      <div className="rating-pod flex items-center gap-[8px]">
                        <div className="rating-card flex items-center gap-[8px]">
                          <span className="reviewLink small text-grey300">
                            Student rating
                          </span>
                        ...
                        <a
                          href="#"
                          className="reviewLink block small text-primary-400 hover:text-primary-500 hover:underline"
                        >
                          View reviews
                        </a>
                      </div>
                    ...
                    <p className="small text-grey300">
                      Want to know what it's like to study this course at uni?
                      We've got all the key info, from entry requirements to the
                      modules on offer. If that all sounds good, why not check
                      out reviews from real students or even book onto an
                      upcoming open day?
                    </p>
                  </div>
                </div>

...
const Examtypemodalcomponents = ({ onClose }:any) => {
  return (
    <AnimatePresence>
            ...
            className='modal-box shadow-custom-6 w-full md:w-[375px] p-[16px_0_16px_16px] bg-white overflow-hidden relative z-0 left-0 h-[100vh]'>
                ...
                <div className='select-subject-container flex flex-col gap-[16px]'>
                    <div className='card-header flex flex-col gap-[4px]'>
                        <div className='h5 text-grey300'>Exam type</div>
                        <p className='para-lg font-semibold text-grey300'>Select a exam type</p>
                    </div>
                    <div className='select-subject-card pr-[16px] custom-scrollbar-2 overflow-y-auto h-[calc(100vh_-_156px)]'>
                        <ul>
                            <li className='flex justify-between items-center gap-[16px] border-b border-b-grey400 pb-[16px] mb-[16px]'>
                                <span className='small font-semibold text-grey300 line-clamp-1 last:!line-clamp-none'>A level</span>
                            ...
                            <li className='flex justify-between items-center gap-[16px] border-b border-b-grey400 pb-[16px] mb-[16px]'>
                                <span className='small font-semibold text-grey300 line-clamp-1 last:!line-clamp-none'>Scottish higher</span>
                                <div className='modal-select'>
                                    <div className='form_check'>
                                        <div className="col flex relative">
                            ...
                            <li className='flex justify-between items-center gap-[16px] border-b border-b-grey400 pb-[16px] mb-[16px]'>
                                <span className='small font-semibold text-grey300 line-clamp-1 last:!line-clamp-none'>UCAS Tariff</span>
                                <div className='modal-select'>
                                    <div className='form_check'>
                                        <div className="col flex relative">
                            ...
                            <li className='flex justify-between items-center gap-[16px] border-b border-b-grey400 pb-[16px] mb-[16px]'>
                                <span className='small font-semibold text-grey300 line-clamp-1 last:!line-clamp-none'>Access to HE Diploma</span>
                                <div className='modal-select'>
                                    <div className='form_check'>
                                        <div className="col flex relative">
                            ...
                            <li className='flex justify-between items-center gap-[16px] border-b border-b-grey400 pb-[16px] mb-[16px]'>
                                <span className='small font-semibold text-grey300 line-clamp-2 last:line-clamp-none'>International Baccalaurete Diploma Programme</span>
                                <div className='modal-select'>
                                    <div className='form_check'>
                                        <div className="col flex relative">
...
export default Examtypemodalcomponents
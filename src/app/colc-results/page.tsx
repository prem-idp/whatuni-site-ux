        ...
        <div className="results_container flex flex-col lg:flex-row md:gap-[40px] lg:gap-[20px] md:px-[20px] lg:px-[0] pb-[40px] md:py-[40px]">
          <section className="results_card flex flex-col  w-full md:rounded-t-[8px] overflow-hidden">
              ...
              <div className="results_edit flex flex-col gap-[16px] md:gap-[0] md:flex-row  justify-between items-start md:items-center w-full">
                <div className="flex flex-col">
                  ...
                  <p className="para font-normal">
                    Here’s your cost of living around the UK
                  </p>
                </div>
                <div className="edit_answers">
                  <button
                    type="button"
                    className="btn btn-primary flex items-center justify-center min-w-[153px] gap-[8px]"
                  >
                    Edit my answers
                  </button>
                </div>
            ...
            <div className="cost_living_container flex flex-col gap-[24px] px-[16px] md:px-[24px] py-[24px] bg-white rounded-b-[8px] overflow-hidden md:border md:border-grey-200 md:shadow-custom-3">
              <div className="average_cost_card flex flex-col gap-[16px]">
                <h5 className="text-heading6">
                  Your average cost of living in the UK
                </h5>
                <div className="average_cost_breakdown flex flex-col rounded-[8px] border-[3px] border-grey-600">
                  <div className="flex justify-between gap-[24px] px-[16px] py-[16px] bg-grey-600">
                    <div className="para-lg font-semibold text-white">
                      UK Average
                    </div>
                    <div className="para-lg font-semibold text-white">
                      £1,500pcm
                  ...
                  <div className="flex flex-col gap-[8px] px-[16px] py-[8px] md:py-[16px] bg-grey-600">
                    <div className="x-small font-semibold text-white">
                    ...
                    <div className="flex flex-wrap md:flex-nowrap justify-between gap-[16px]">
                      <div className="flex flex-col gap-[4px] basis-[47%] md:basis-[20%]">
                        ...
                        <div className="small font-normal text-white">
                          £1,612pcm
                        </div>
                      </div>
                      <div className="flex flex-col gap-[4px] basis-[47%] md:basis-[20%]">
                  ...
                  <div className="flex px-[16px] py-[16px] bg-neutral-100 rounded-b-[8px]">
                    <div className="flex flex-col gap-[4px] basis-[50%]">
                      <div className="small font-semibold text-neutral-700">
                        Income
                      </div>
                      <div className="small font-normal text-neutral-700">
                        £1,612pcm
                      </div>
                    </div>
              ...
              <div className="your_cost_card flex flex-col gap-[16px]">
                <h5 className="text-heading6">
                  Your cost of living around the UK
                </h5>
                <div className="your_cost_of_living flex flex-col gap-[16px] md:gap-[8px] md:flex-row md:items-center justify-between ">
                  <ul className="flex items-center gap-[8px] cursor-pointer">
                    <li
                      className={`active rounded-[20px] px-[12px] py-[8px] small font-semibold inline-block hover:bg-black hover:text-white border border-grey-500`}
                    >
                      University
                    </li>
                    <li
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="Search"
                      className="w-full small font-normal text-grey300 py-[10px] pl-[10px] pr-[36px] border border-grey-500 rounded-[4px] outline-none focus:border focus:border-primary-400"
                    />
                    ...
                    <div className="accordion-header flex flex-col justify-center min-h-[56px] py-[8px] md:py-[16px] pl-[16px] pr-[16px] md:pr-[24px] border-t-0 border-b border-grey-200 hover:bg-primary-50 first:border-t">
                      <div className="flex w-full gap-[8px] justify-between">
                        <div className="accord_uni_list flex items-center gap-[6px] md:w-[calc(100%_-_200px)]">
                          ...
                          <Link
                            className="small font-semibold text-primary-400 hover:text-primary-500 line-clamp-2 lg:line-clamp-1"
                            href={""}
                          >
                            Abertay University
                          </Link>
                        ...
                        <div className="flex items-center gap-[24px] ">
                          <span className="small font-semibold text-grey300">
                            £1,500pcm
                          </span>
                          <span className="cursor-pointer">
                            <svg
                      ...
                      <div className="accordion-body mt-[16px] mb-[8px] md:mb-[0]">
                        <div className="average_cost_breakdown flex flex-col rounded-[8px] overflow-hidden">
                          <div className="flex flex-col gap-[8px] px-[16px] py-[16px] bg-grey-50">
                            <div className="x-small font-semibold text-grey300">
                              COST OF LIVING BREAKDOWN
                            </div>
                            <div className="flex flex-wrap md:flex-nowrap justify-between gap-[16px]">
                              <div className="flex flex-col gap-[4px] basis-[47%] md:basis-[20%]">
                                ...
                                <div className="small font-normal text-grey300">
                                  £1,612pcm
                                </div>
                              </div>
                              <div className="flex flex-col gap-[4px] basis-[47%] md:basis-[20%]">
                        ...
                        <div className="find_out_more flex flex-col gap-[8px] mt-[16px]">
                          <div className="x-small font-semibold text-grey300 uppercase">
                            Nearby universities
                          </div>
                          <ul className="flex flex-col gap-[8px] pl-[18px] *:list-disc *:text-[18px] *:text-primary-400">
                            <li>
                              <Link
                                href={""}
                                className="small font-normal hover:underline"
                              >
                                Abertay University
                              </Link>
                            </li>
                          ...
                          <div className="view_more">
                            <Link
                              href={""}
                              className="small font-semibold text-primary-400 hover:text-primary-500 hover:underline"
                            >
                              <span className="text-[20px]">+</span> View more
                            </Link>
                          </div>
                        </div>
                        {/* near by universities */}
                      ...
                      <div className="flex gap-[8px] justify-between">
                        <div className="accord_uni_list flex items-center gap-[6px] md:w-[calc(100%_-_200px)]">
                          ...
                          <Link
                            ...
                            href={""}
                          >
                            Birkbeck University of London Birkbeck University of
            ...
            <div className="uni_compare flex flex-col gap-[16px] px-[16px] pt-[40px] md:px-[0]">
              ...
              <p>
                Plan your budget with our new Cost of Living Calculator. Compare
                uni cities across the UK, see all expenses in one place, and
                avoid surprises. Make informed choices to ensure the best uni
                experience—both academically and financially.
              </p>
              <div className="find_out_more flex flex-col gap-[8px] bg-grey-50 border-l-4 border-l-grey-500 px-[16px] py-[16px]">
                ...
                <ul className="flex flex-col gap-[8px]">
                  <li>
                    <Link
                      href={""}
                      className="para font-normal text-primary-400 hover:underline"
                    >
                      Methodology
                    </Link>
                  </li>
            ...
            <div className="advert_card flex flex-col justify-between items-center gap-[24px] rounded-[8px] bg-blue-200 px-[24px] pt-[24px]">
              <div className="advert_header_card flex flex-col gap-[16px]">
                <div className="advert_content_card flex flex-col gap-[4px]">
                  ...
                  <p className="small font-normal">
                    Access university rankings, student reviews, and everything
                    you need to make informed choices—all in one place!
                  </p>
                </div>
                <ul className="flex flex-row gap-[16px]">
                  <li>
